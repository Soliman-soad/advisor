...
const ServiceCard = () => {
    return (
        <div className='text-center max-w-[400px] space-y-5 shadow-lg shadow-md my-10 py-14 px-16 group hover:bg-sky-800 hover:-translate-y-5 transition-all delay-200 ease-in-out rounded-lg cursor-pointer mx-auto'>
