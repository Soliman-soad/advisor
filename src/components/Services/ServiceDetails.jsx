...
const ServiceDetails = () => {
  ...
  return (
    <div className="md:px-0 px-5">
      {/* service type title */}
      <div className="lg:h-screen h-96 relative">
        <div className="absolute w-full h-full -z-10 object-cover">
          <img
            src="https://img.freepik.com/free-photo/facade-old-building-with-columns-new-york-stock-exchange_23-2148184273.jpg?w=740&t=st=1680712081~exp=1680712681~hmac=d1ec7fe767871ee300f9a8109ee2db9f399f78f02eea02fdfa74d6618698ec7e"
            alt=""
      ...
      <div className="md:grid grid-cols-12 gap-10 my-20">
        ...
        <div className="md:block hidden col-span-3 space-y-5">
          ...
          <div className="relative h-[480px] rounded-lg">
            ...
            <div className="bg-slate-800/80 w-full h-full flex justify-center flex-col text-white space-y-5 px-10">
              <h1 className="text-indigo-300 font-semibold text-xl">
                Let us help you!
              </h1>
              ...
              <h3 className="text-xl font-semibold">Call : +8801515275356</h3>
        ...
        <div className="col-span-9 space-y-10">
          <div className="space-y-5">
            ...
            <div>
              <p>
                Our Trading helps clients run and transform their front, middle
                and back-office trading operations. We provide buy-side,
                sell-side and market infrastructure firms with a full-service
                offering, including systems integration and technology
                consulting services, to assist in delivering high performance
                trading and settlement capabilities across all asset classes.
                This includes strategy, architecture design, operating model
                work, process improvement. These apps run on a custom built
                blockchain, an enormously powerful shared global infrastructure
                that can move value around and represent the ownership of
                property. This enables developers to create markets, store
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 my-10">
            <div>
              <img
                src="https://img.freepik.com/free-photo/facade-old-building-with-columns-new-york-stock-exchange_23-2148184273.jpg?w=740&t=st=1680712081~exp=1680712681~hmac=d1ec7fe767871ee300f9a8109ee2db9f399f78f02eea02fdfa74d6618698ec7e"
                className="max-w-[380px] max-h-[400px] md:max-h-full md:max-w-full md:w-full md:h-full mx-auto"
                alt=""
              />
            </div>
            <div className="space-y-5">
              ...
              <div className="space-y-10 ">
                <div>
                  ...
                  <p>
                    ...
                    charge by a number of brokers, including banks.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold">
          ...
          <div className="space-y-5">
            ...
            <div>
              <p>
                ...
                offering, including systems integration and technology
                consulting services, to assist in delivering high performance
                trading and settlement capabilities across all asset classes and
                many other things that have not been invented yet, all without a
                middleman.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-center gap-5">
              <div className="space-y-4">
                ...
                <h3 className="text-gray-600 font-serif font-semibold">
                  PRIVATE
                </h3>
                <p>
          ...
          <div className="space-y-5">
            ...
            <form onSubmit={slotForm}>
              <div className="w-[300px] border mx-auto px-3 py-2 mb-4 relative text-center">                
                <label                  
                 htmlFor="slotDate"
                >
                    {
                  ...
                  <MdDateRange className="inline ml-16 text-2xl"/>
                </label>
                ...
                <input
                  ...
                  id="slotDate"
                  name="slotDate"
                  className="absolute -left-12 -top-0 opacity-0 text-4xl"
                  onSelectCapture={(e)=>setBookDate(e.target.value)}
                />
              </div>
              ...
              <div className="mt-8 text-center">
                <h2>
                  You have select : {bookTime && bookDate ?`Date ${bookDate} at ${bookTime}` : "Nothing selected"}{" "}
                </h2>
                <button
                  type="submit"
                  className="btn bg-sky-500 text-white py-2 px-3 rounded-md cursor-pointer hover:bg-gray-700 mt-2"
                >
                  Confirm
                </button>
              </div>
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center">
              ...
              <button
                type="submit"
                className="btn bg-slate-700 text-white py-2 px-4 rounded ml-2"
              >
                Comment
              </button>
            </div>
